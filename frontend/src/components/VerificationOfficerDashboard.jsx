...
const VerificationOfficerDashboard = () => {
  ...
  const verifyApplication = async (applicationId, verified) => {
    ...
    if (verified) {
      ...
      if (!allChecked) {
        setVerificationError("Please check all required fields before verifying the application.");
        return;
      }
    }
    ...
    try {
      ...
      updateApplicationState(applicationId, verified, comments);
  ...
  const updateApplicationState = (applicationId, verified, comments) => {
  ...
  return (
    <div className="vo-verification-dashboard">
      ...
      {loading && (
        <div className="voja-loading-spinner">
          <div />
        </div>
      )}
        ...
        {assignedApplications.length === 0 && !loading ? (
          ...
          <div className="vo-applications-list">
            {assignedApplications.map((app) => {
              ...
              return (
                <div key={app._id} className="vo-application-row">
                  <div className="vo-application-left">
                    ...
                    <div className="vo-status">
                      {app.verified && app.verifiedBy?.name && app.verifiedBy?.role ? (
                        <span className="vo-verified">
                          Verified by {app.verifiedBy.name} ({formatRole(app.verifiedBy.role)})
                        </span>
                      ) : (
            ...
            {selectedStudent.application && !selectedStudent.application.verified && (
              <div className="vo-verification-progress">
                ...
                <div className="vo-checkbox-helper">
                  Please check all required fields to verify this application
                </div>
              </div>
            )}
            ...
            {selectedStudent.application && (
              <div className="vo-details-section">
                ...
                <textarea
                  ...
                  placeholder="Enter verification/unverification comments (optional)"
                  rows="4"
                  style={{
                    width: "100%",
                    padding: "0.8rem",
